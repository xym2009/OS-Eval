close all;clc;
geocodedL2P = 'D:\CodeLib\GeoRefine-PackageEXE\L2.exe';
...
for k=1:11
    for kk=1:13
        for kkk=1:9
            ...
            %% match geotiff
            tic
            o = 8;Nr = 3;PS = 84;K = 0.008;cform='affine';
            ...
            [solution,rmse,matchedPoints1,matchedPoints2]=ASS_match(ssf1.des,double(ssf1.kps),ssf2.des,double(ssf2.kps),cform);
            toc
            %% save links
            addpath '..\RPCprocess'
