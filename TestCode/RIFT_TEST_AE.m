...
[DEMSRC,dR]=geotiffread('Absolute-dataset\ZZG_USGS10m_WGS84.tif');
k=1;
for kkk=2:8
    name1=[optN{k},'-',num2str(kkk)]; 
    inTIF1 = [' Absolute-dataset\Google+GT\',name1,'.tiff'];
    file_image1=['Absolute-dataset\Processed\OPT\',name1,'-L2.tiff'];
    outTIF1 = [' ',file_image1];
    ...
    for kk=1:19
        ...
        file_image2=['Absolute-dataset\Processed\SAR-ORG-DEM\',name2,'-L2.tiff'];
       %% geocodedL2P
        ...
        %% save links
        addpath '..\RPCprocess'
        rpc_image2=['Absolute-dataset\SAR+RPC+GT\',name2,'.rpb']; RPC2=readRPC(rpc_image2);
